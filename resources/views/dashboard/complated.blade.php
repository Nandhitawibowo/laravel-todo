    ...
    <div id="comments" class="mt-1">
        ...
        <div class="comment d-flex align-items-start justify-content-between">
            ...
            <div class="d-flex flex-column w-75"> 
                ...
                <p class="text muted"> {{ $todo['status'] ? 'Complated' :
                    'On-Progress' }} <span class="date"><br>{{ \Carbon\Carbon::parse($todo['date'])->format('j F, Y') }}
                </span></p>
            </div>
            <div class="ml-auto">
                {{-- ketika akan membuat fitur delete, harus menggunakan form, kenapa? karena kalau kita jalanin fitur delete 
                    itukan artinya mau ubah di database nya kan? kalau hal2 yg berhubungan dengan modifikasi database harus menggunakan form --}}
