...
class TodoController extends Controller
{
    ...
    public function updateComplated($id)
    {
        ...
        // kalau berhasi bakal diarahin ke halaman list todo yg complated dengan pemberitahuan
    ...
    public function destroy($id)
    {
        ...
        //cari data yang isian coloumn id nya sama dengan $id yang dikirim ke path dinamis
